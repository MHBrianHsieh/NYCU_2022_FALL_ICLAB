...
// 2.0     2022-10-24 Brian Hsieh      modify PE to reduce adder   8998632.457184   6.5         5.26340009646654798355864064e14
//                                                                 9043987.904407   6.3         5.153004184548787520311363887e14
//                                                                 9215550.311928   6.2         5.265434788203928002142785408e14
//                                                                 9252440.087102   6.1         5.222066501490135986152262644e14
//                                                                 9281559.363145   6           5.1688406526950770790574615e14
//                                                                 9301467.865100   5.9         5.10452096228378915608259e14
// -----------------------------------------------------------------------------
...
wire signed [ 31:0] pe_outputc_32    [0:15];
wire signed [ 32:0] pe_outputc_33    [0: 1][0:15];
wire signed [ 33:0] pe_outputc_34    [0: 3][0:15];
wire signed [ 34:0] pe_outputc_35    [0: 7][0:15];
wire signed [ 35:0] pe_outputc_36    [0:15];
...
always @(*) begin
  if (current_state == OUT) begin
    case(matrix_size_r)
      4'd1: begin
        out_value_ns = pe_outputc_33[0][0] + pe_outputc_33[0][1];
      end
      4'd3: begin
        out_value_ns = pe_outputc_34[0][0] + pe_outputc_34[0][1] + pe_outputc_34[0][2] + pe_outputc_34[0][3];
      end
      4'd7: begin
        out_value_ns = pe_outputc_35[0][0] + pe_outputc_35[0][1] + pe_outputc_35[0][2] + pe_outputc_35[0][3] + pe_outputc_35[0][4] + pe_outputc_35[0][5] + pe_outputc_35[0][6] + pe_outputc_35[0][7];
      end
      4'd15: begin
        out_value_ns = pe_outputc_36[0] + pe_outputc_36[1] + pe_outputc_36[ 2] + pe_outputc_36[ 3] + pe_outputc_36[ 4] + pe_outputc_36[ 5] + pe_outputc_36[ 6] + pe_outputc_36[ 7] +
                       pe_outputc_36[8] + pe_outputc_36[9] + pe_outputc_36[10] + pe_outputc_36[11] + pe_outputc_36[12] + pe_outputc_36[13] + pe_outputc_36[14] + pe_outputc_36[15];
      end
      default: begin
        out_value_ns = 40'd0;
      end
...
PE_35 u_PE91 (
  ...
  .inputb  (pe_outputc_35[0][0]  ),
  .weight  (pe_weight[8][15:0]   ),
  .outputc (pe_outputc_35[1][0]  ),
...
generate
  for (i9=0; i9<15; i9=i9+1) begin: mac_row9
    PE_35 u_PE9(
      ...
      .inputb  (pe_outputc_35[0][i9+1]          ),
      .weight  (pe_weight [8][16*i9+31:16*i9+16]),
      .outputc (pe_outputc_35[1][i9+1]          ),
...
PE_35 u_PEa1 (
  ...
  .inputb  (pe_outputc_35[1][0]  ),
  .weight  (pe_weight[9][15:0]   ),
  .outputc (pe_outputc_35[2][0]  ),
...
generate
  for (i10=0; i10<15; i10=i10+1) begin: mac_rowa
    PE_35 u_PEa(
      ...
      .inputb  (pe_outputc_35[1][i10+1]           ),
      .weight  (pe_weight [9][16*i10+31:16*i10+16]),
      .outputc (pe_outputc_35[2][i10+1]           ),
...
PE_35 u_PEb1 (
  ...
  .inputb  (pe_outputc_35[2][0]   ),
  .weight  (pe_weight[10][15:0]   ),
  .outputc (pe_outputc_35[3][0]   ),
...
generate
  for (i11=0; i11<15; i11=i11+1) begin: mac_rowb
    PE_35 u_PEb(
      ...
      .inputb  (pe_outputc_35[2][i11+1]            ),
      .weight  (pe_weight [10][16*i11+31:16*i11+16]),
      .outputc (pe_outputc_35[3][i11+1]            ),
...
PE_35 u_PEc1 (
  ...
  .inputb  (pe_outputc_35[3][0] ),
  .weight  (pe_weight [11][15:0]),
  .outputc (pe_outputc_35[4][0] ),
...
generate
  for (i12=0; i12<15; i12=i12+1) begin: mac_rowc
    PE_35 u_PEc(
      ...
      .inputb  (pe_outputc_35[3][i12+1]            ),
      .weight  (pe_weight [11][16*i12+31:16*i12+16]),
      .outputc (pe_outputc_35[4][i12+1]            ),
...
PE_35 u_PEd1 (
  ...
  .inputb  (pe_outputc_35[4][0]   ),
  .weight  (pe_weight [12][15:0]  ),
  .outputc (pe_outputc_35[5][0]   ),
...
generate
  for (i13=0; i13<15; i13=i13+1) begin: mac_rowd
    PE_35 u_PEd(
      ...
      .inputb  (pe_outputc_35[4][i13+1]            ),
      .weight  (pe_weight [12][16*i13+31:16*i13+16]),
      .outputc (pe_outputc_35[5][i13+1]            ),
...
PE_35 u_PEe1 (
  ...
  .inputb  (pe_outputc_35[5][0]   ),
  .weight  (pe_weight [13][15:0]  ),
  .outputc (pe_outputc_35[6][0]   ),
...
generate
  for (i14=0; i14<15; i14=i14+1) begin: mac_rowe
    PE_35 u_PEe(
      ...
      .inputb  (pe_outputc_35[5][i14+1]            ),
      .weight  (pe_weight [13][16*i14+31:16*i14+16]),
      .outputc (pe_outputc_35[6][i14+1]            ),
...
PE_35 u_PEf1 (
  ...
  .inputb  (pe_outputc_35[6][0]   ),
  .weight  (pe_weight [14][15:0]  ),
  .outputc (pe_outputc_35[7][0]   ),
...
generate
  for (i15=0; i15<15; i15=i15+1) begin: mac_rowf
    PE_35 u_PEf(
      ...
      .inputb  (pe_outputc_35[6][i15+1]            ),
      .weight  (pe_weight [14][16*i15+31:16*i15+16]),
      .outputc (pe_outputc_35[7][i15+1]            ),
...
PE_36 u_PEg1 (
  ...
  .inputb  (pe_outputc_35[7][0]          ),
  .weight  (pe_weight [15][15:0]         ),
  .outputc (pe_outputc_36[0]             ),
...
generate
  for (i16=0; i16<15; i16=i16+1) begin: mac_rowg
    PE_36 u_PEg(
      ...
      .inputb  (pe_outputc_35[7][i16+1]            ),
      .weight  (pe_weight [15][16*i16+31:16*i16+16]),
      .outputc (pe_outputc_36[i16+1]               ),
